...
@section('title', 'Add Retur Penjualan')
@section('header')
...
@section('content')
    <form action="" class="border">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="phone">No SO</label>
                        <input type="tel" readonly class="form-control-plaintext" placeholder="" id="noSO"
                            name="noSO">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="email">Tgl SO</label>
                        <input type="email" class="form-control" placeholder="" id="tglSO"
                            name="tglSO">
                    </div>
                </div>
                <div class="col-md-6">
