...
<div class="main">
    <div id="printPanel" class="col-sm-12 center-block print-panel">
        ...
        <h4 align="center">FAKTUR PENJUALAN</h4><br/>
        ...
        <tr>
            ...
            <td><label class="control-label">Kepada Yth., </label><br/>
                {{$faktur->trpenawaran->customer->Nama}}
                <br/>
        ...
        <table id="tblinvoice" class="print-table" width="100%">
            ...
            <tbody>
                @foreach($faktur->trpenawaran->barangs as $coco)
                <tr>
        ...
        <tr>
            ...
            <div style="font-weight:bold;text-align:right;">
                ...
                <span style="padding-right: 2px">PPN <input type="text" id="PPN" name="PPN" value="{{$faktur->trpenawaran->PPN}}"style="border:none; width: 20px;background-color:#ebfaff" size="5" readonly />  % </span><span>:</span><br/>
                <span style="padding-right: 40px">Total</span><span>:</span>
            </div>
            </td>
            <td style="width:50px">
                <div style="font-weight:bold;text-align:right;">
                <input type="text" value="{{$faktur->trpenawaran->subtotal}}" name="subtotal" id="subtotal" style="border:none;text-align:right;background-color:#ebfaff"  size="20" readonly /><br/>
                <input type="text" value="{{($faktur->trpenawaran->PPN * $faktur->trpenawaran->subtotal/100)}}" name="RpPPN" id="RpPPN" style="border:none;text-align:right;background-color:#ebfaff"  size="20" readonly /><br/>
                <input type="text" id="total" name="total" value="{{$faktur->trpenawaran->total}}" style="border:none;text-align:right;background-color:#ebfaff" size="20"/>
                </div>
            </td>
        </tr>
        </table>
